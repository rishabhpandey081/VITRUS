    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <h1 style={{ fontSize: '20px', fontWeight: 'bold', color: 'var(--v-gold-500)', margin: 0 }}>Live AI Video & Voice Mock Interview</h1>
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <label style={{ fontSize: '13px', color: 'var(--v-ink-muted)' }}>Target Role:</label>
          <select
            value={role}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <span style={{ fontSize: '13px', fontWeight: '600', color: 'var(--v-ink-muted)' }}>Your Live Camera Feed</span>
            <span style={{
              fontSize: '11px',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginTop: '16px' }}>
            <button
              onClick={toggleMic}
              style={{
                backgroundColor: isMicMuted ? '#ef4444' : 'var(--v-glass-border)',
                color: 'white',
                border: 'none',
                borderRadius: '8px',
                padding: '10px 16px',
            ...
            <button
              ...
              style={{
                backgroundColor: isCameraActive ? 'var(--v-glass-border)' : 'var(--v-gold-700)',
                color: 'white',
                border: 'none',
                borderRadius: '8px',
                padding: '10px 16px',
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '16px', borderBottom: '1px solid var(--v-glass-border)', paddingBottom: '12px' }}>
            <h2 style={{ fontSize: '16px', fontWeight: '600', color: 'white', margin: '0 0 4px 0' }}>AI Voice & Video Interviewer</h2>
            <p style={{ fontSize: '12px', color: 'var(--v-ink-muted)', margin: 0 }}>Role: <span style={{ color: 'var(--v-gold-500)' }}>{role}</span></p>
          </div>
          ...
          <form onSubmit={handleSendMessage} style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <div style={{
              ...
              alignItems: 'center',
              backgroundColor: 'var(--v-bg-elevated)',
              border: `1px solid ${isListening ? '#ef4444' : 'var(--v-glass-border)'}`,
              borderRadius: '12px',
              padding: '0 12px',
              ...
              <button
                ...
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: isListening ? '#ef4444' : 'var(--v-ink-muted)',
